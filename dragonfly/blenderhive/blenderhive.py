...
class blender_actorwrapper(object):
  ...
  def animate(self, animation_name, loop=None, mode=None):
    ...
    if loop == False: mode = "play"
    elif loop == True: mode = "loop"
    ...
    import bge
    if mode == "play": m = bge.logic.KX_ACTION_MODE_PLAY
    elif mode == "loop": m = bge.logic.KX_ACTION_MODE_LOOP
    elif mode == "pingpong": m = bge.logic.KX_ACTION_MODE_PING_PONG
