...
from ..commandhive import inputhandler
...
class blendercommandapp(bee.drone):
    def __init__(self):
...
from ..commandhive.commandhive import commandhive_exit


class blendercommandhive(bee.inithive):
    _hivecontext = hivemodule.appcontext(blendercommandapp)
