...
class entitybinder_view(binderdrone):
    ...
    def place(self):
        ...
        libcontext.socket(("get_entity", "view", self._view, "NodePath"),
                          socket_single_required(self.set_entityfunc_nodepath))
        libcontext.socket(("get_entity", "view", self._view, "AxisSystem"),
                          socket_single_required(self.set_entityfunc_axissystem))
