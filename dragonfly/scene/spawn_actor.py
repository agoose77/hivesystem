...
class spawn_actor(bee.worker):
  ...
  @modifier
  def do_spawn(self):
    self.spawnfunc(self.b_actorclassname, self.v_actorname)
  ...
  def place(self):
    ...
    libcontext.socket(("spawn","actor"), socket_single_required(self.set_spawnfunc))
