...
m.init()
print "BLOCKS:"
for g in m.select_block.w_blocks.get_value(): print g.get_values()
print "SELECTED :", m.blockgrid.value.get_values()
m.test.trigger()
print "SELECTED :", m.blockgrid.value.get_values()
...
m2.init()
print "BLOCKS2:"
for g in m2.select_block.w_blocks.get_value(): print g.get_values()
print "SELECTED2:", m2.blockgrid.value.get_values()
m2.test.trigger()
print "SELECTED2:", m2.blockgrid.value.get_values()
print "SELECTED :", m.blockgrid.value.get_values()
