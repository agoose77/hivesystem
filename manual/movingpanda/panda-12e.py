...
class myhive(dragonfly.pandahive.pandahive):
  ...
  t_get_selected = dragonfly.std.transistor("id")()
  connect(sel.selected, t_get_selected)
  connect(t_get_selected, selected)
  disp_sel = dragonfly.io.display("id")("Selected: ")
  connect(t_get_selected, disp_sel)
  ...
  connect(t_kill, z_pandawalk.stop)
