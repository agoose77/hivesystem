...
class myhive(dragonfly.pandahive.pandahive):
  ...
  #Third panda
  pandaspawn3 = dragonfly.scene.spawn() 
  v_panda3 = dragonfly.std.variable("id")("pandaclass3")
  connect(v_panda3, pandaspawn3)
  
  do_spawn3 = dragonfly.std.transistor(("id",("object","matrix")))()
  connect(w_spawn, do_spawn3)
  connect(do_spawn3, pandaspawn3.spawn_matrix)

  pandaicon_click3 = dragonfly.io.mouseareasensor("pandaicon3")
  connect(pandaicon_click3, do_spawn3)
