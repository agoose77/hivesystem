...
class myhive(dragonfly.pandahive.pandahive):
    ...
    pandaicon_click = dragonfly.io.mouseareasensor("pandaclass")
    ...
    pandaicon_click2 = dragonfly.io.mouseareasensor("pandaclass2")
    ...
    pandaicon_click3 = dragonfly.io.mouseareasensor("pandaclass3")
