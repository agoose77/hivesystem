...
class pandawalkhive2(pandawalkhive):
  key_w = None
  key_e = dragonfly.io.keyboardsensor_trigger("E")
  connect(key_e, ("animation","loop"))
  connect(key_e, ("interval","start"))
  connect(key_e, ("ip1","start"))
  connect(key_e, ("ip2","start"))
  connect(key_e, ("ip3","start"))
  connect(key_e, ("ip4","start"))
